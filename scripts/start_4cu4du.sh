...
echo "=== Starting 4CU-4DU topology ==="
echo "Starting 5GC..."
$COMPOSE up -d 5gc
wait_healthy open5gs_5gc

echo "Starting CU-CPs..."
$COMPOSE up -d cu-cp cu-cp2 cu-cp3 cu-cp4
wait_healthy srsran_cu_cp
wait_healthy srsran_cu_cp2
wait_healthy srsran_cu_cp3
wait_healthy srsran_cu_cp4

echo "Starting CU-UPs..."
$COMPOSE up -d cu-up cu-up2 cu-up3 cu-up4
sleep 10

echo "Starting DUs..."
$COMPOSE up -d du du-b du-c du-d
sleep 10
