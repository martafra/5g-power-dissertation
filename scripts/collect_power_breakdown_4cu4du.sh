...
CU_CP4=$(get_pid srsran_cu_cp4)
CU_UP4=$(get_pid srsran_cu_up4)
DU1=$(get_pid srsran_du)
DU_B=$(get_pid srsran_du_b)
DU_C=$(get_pid srsran_du_c)
DU_D=$(get_pid srsran_du_d)

echo "=== srsRAN Power Breakdown Collector ==="
echo "Topology: $TOPOLOGY"
echo "PIDs: CU-CP=$CU_CP | CU-UP=$CU_UP | CU-CP2=$CU_CP2 | CU-UP2=$CU_UP2 | CU-CP3=$CU_CP3 | CU-UP3=$CU_UP3 | CU-CP4=$CU_CP4 | CU-UP4=$CU_UP4 | DU1=$DU1 | DU_B=$DU_B | DU_C=$DU_C | DU_D=$DU_D"
...
for i in $(seq 1 $SAMPLES); do
    ...
    for ENTRY in "cu_cp:$CU_CP" "cu_up:$CU_UP" "cu_cp2:$CU_CP2" "cu_up2:$CU_UP2" "cu_cp3:$CU_CP3" "cu_up3:$CU_UP3" "cu_cp4:$CU_CP4" "cu_up4:$CU_UP4" "du1:$DU1" "du_b:$DU_B" "du_c:$DU_C" "du_d:$DU_D"; do
