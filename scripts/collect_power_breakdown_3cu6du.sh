...
DU_B2=$(get_pid srsran_du_b2)
DU_C=$(get_pid srsran_du_c)
DU_C2=$(get_pid srsran_du_c2)
DU_C3=$(get_pid srsran_du_c3)

echo "=== srsRAN Power Breakdown Collector ==="
echo "Topology: $TOPOLOGY"
echo "PIDs: CU-CP=$CU_CP | CU-UP=$CU_UP | CU-CP2=$CU_CP2 | CU-UP2=$CU_UP2 | CU-CP3=$CU_CP3 | CU-UP3=$CU_UP3 | DU1=$DU1 | DU2=$DU2 | DU_B=$DU_B | DU_B2=$DU_B2 | DU_C=$DU_C | DU_C2=$DU_C2 | DU_C3=$DU_C3"
...
for i in $(seq 1 $SAMPLES); do
    ...
    for ENTRY in "cu_cp:$CU_CP" "cu_up:$CU_UP" "cu_cp2:$CU_CP2" "cu_up2:$CU_UP2" "cu_cp3:$CU_CP3" "cu_up3:$CU_UP3" "du1:$DU1" "du2:$DU2" "du_b:$DU_B" "du_b2:$DU_B2" "du_c:$DU_C" "du_c2:$DU_C2" "du_c3:$DU_C3"; do
