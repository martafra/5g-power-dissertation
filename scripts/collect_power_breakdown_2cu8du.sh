...
DU_B3=$(get_pid srsran_du_b3)
DU_B4=$(get_pid srsran_du_b4)

echo "=== srsRAN Power Breakdown Collector ==="
echo "Topology: $TOPOLOGY"
echo "PIDs: CU-CP=$CU_CP | CU-UP=$CU_UP | CU-CP2=$CU_CP2 | CU-UP2=$CU_UP2 | DU1=$DU1 | DU2=$DU2 | DU3=$DU3 | DU_B=$DU_B | DU_B2=$DU_B2 | DU_B3=$DU_B3"
...
for i in $(seq 1 $SAMPLES); do
    ...
    for ENTRY in "cu_cp:$CU_CP" "cu_up:$CU_UP" "cu_cp2:$CU_CP2" "cu_up2:$CU_UP2" "du1:$DU1" "du2:$DU2" "du3:$DU3" "du4:$DU4" "du_b:$DU_B" "du_b2:$DU_B2" "du_b3:$DU_B3" "du_b4:$DU_B4"; do
